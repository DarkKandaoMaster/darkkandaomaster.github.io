...
## 技术与结构
原生 HTML、CSS、JavaScript，无运行时依赖，直接兼容现有 GitHub Pages main 分支根目录部署。测试使用 Playwright 和 axe。保留 CNAME 与 .nojekyll。
...
## 执行顺序
- [ ] 基础工具、设计与内容来源记录。
- [ ] 首页静态布局与视觉素材，浏览器检查并保存提交。
- [ ] 筛选、主题、导航与联系交互，验证功能。
- [ ] 公开简历、404、站点元数据与文档。
- [ ] 多尺寸截图、可访问性与浏览器测试，审阅、发布和线上核验。
